 ...
 * @author Jared341
 */
public class LegacyScheduleTrajectoryFollower {
    ...
    public LegacyScheduleTrajectoryFollower(String name) {
        this.name = name;
    }
    ...
    public double getSpeed() {
    	if(this.name.equals("left")) {
            return (Robot.getRobotState().drivePose.leftSpeed/(12.0*Constants.kDriveSpeedUnitConversion));
        } else if(this.name.equals("right")) {
            return (Robot.getRobotState().drivePose.rightSpeed/(12.0*Constants.kDriveSpeedUnitConversion));
        } else {
            return 0.0;
        }
    }
